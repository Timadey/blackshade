...
const BoardShareModal = ({ isOpen, onClose, board, isOwner, onEditSlug }) => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className="glass-card w-full max-w-md relative animate-fade-in">
                ...
                <div className="flex items-center justify-between">
                    <span className="text-[10px] font-black text-secondary uppercase tracking-[0.2em] ml-1">Your Board Link</span>
                    {isOwner && onEditSlug && (
                        <button
                            onClick={onEditSlug}
                            className="text-[10px] font-black text-blue-400 hover:text-blue-300 uppercase tracking-widest transition-all p-1"
                        >
                            Edit Handle❓
                        </button>
                    )}
                ...
                <div className="space-y-4">
                    {navigator.share && (
                        <button
                            ...
                            className="w-full glass-button bg-white text-gray-400 border-none font-black uppercase tracking-[0.2em] text-xs py-4 flex items-center justify-center gap-3 hover:bg-white/90 active:scale-95 transition-all shadow-xl shadow-white/10"
                        >
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-[10px]">
                            <span className="px-2 bg-black/20 backdrop-blur-md text-secondary font-black uppercase tracking-widest leading-none">Social Media</span>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button
                            ...
                            className="glass-button flex items-center justify-center gap-2 bg-[#25D366]/5 hover:bg-[#25D366]/10 border-[#25D366]/10 text-xs py-3.5 transition-all active:scale-95"
                        >
                        ...
                        <button
                            ...
                            className="glass-button flex items-center justify-center gap-2 bg-[#1DA1F2]/5 hover:bg-[#1DA1F2]/10 border-[#1DA1F2]/10 text-xs py-3.5 transition-all active:scale-95"
                        >
                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <button
                            ...
                            className="glass-button flex items-center justify-center gap-2 bg-[#1877F2]/5 hover:bg-[#1877F2]/10 border-[#1877F2]/10 text-xs py-3.5 transition-all active:scale-95"
                        >
                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <button
                            ...
                            className="glass-button flex items-center justify-center gap-2 bg-[#0088cc]/5 hover:bg-[#0088cc]/10 border-[#0088cc]/10 text-xs py-3.5 transition-all active:scale-95"
                        >
                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                <button
                    onClick={onClose}
                    className="w-full mt-8 glass-button bg-white/5 text-secondary hover:bg-white/10 font-black uppercase tracking-widest text-[10px] py-4 border-white/5 active:scale-95 transition-all"
                >
                    Done
                </button>
            </div>
